  ...
  function initMermaid() {
    ...
    mermaid.initialize({
      ...
      themeVariables: {
        ...
        primaryColor: isDark ? '#1e293b' : '#e0e7ff',
        primaryBorderColor: isDark ? '#475569' : '#c7d2fe',
        primaryTextColor: isDark ? '#f1f5f9' : '#0f172a',
        secondBkgColor: isDark ? '#334155' : '#f0f4ff',
        secondBorderColor: isDark ? '#475569' : '#a5b4fc',
        tertiaryColor: isDark ? '#475569' : '#ddd6fe',
